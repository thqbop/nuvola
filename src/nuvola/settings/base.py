...
AUTHENTICATION_BACKENDS = [
    ...
    'nuvola.authentications.TokenAuthentication'
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'admin_site.permissions.IsAuthenticated'
        # 'rest_framework.permissions.AllowAny'
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'admin_site.authentications.TokenAuthentication'
    ],
...
SENDGRID_API_KEY = env('SENDGRID_API_KEY',
                       default='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')
...
LOCALE_PATHS = (
                ...
                BASE_DIR + '/../../nuvola/src/nuvola/locale/manual',
                )
...
GOOGLE_CLIENT_ID = env("GOOGLE_CLIENT_ID",
                       default='310203758762-vkc9hocnecbbcshsgf2ufctttp74pbgm.apps.googleusercontent.com')
